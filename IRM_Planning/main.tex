...
% \subsubsection{Frontier detection/pruning}

% Frontier nodes on the IRM are generated and deleted by a repeated process while the robots are exploring.
...
\centering
    \begin{tikzpicture}
	    ...
	    \begin{scope}[x={(image.south east)},y={(image.north west)}]
	    	...
	    	% Annotations
	    	\node [font=\scriptsize,above left,align=right,white] at (0.1,0.66) {1.8 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.43,0.66) {3.6 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.76,0.66) {6.6 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.1,0.33) {9.6 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.44,0.33) {14.4 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.77,0.33) {15.6 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.11,0.005) {24.6 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.43,0.005) {27 m};
	    	\node [font=\scriptsize,above left,align=right,white] at (0.75,0.005) {60 m};
...
\begin{figure}[ht!]
  \includegraphics[width=.48\textwidth]{figures/paths_on_map.png}
  \centering
