...
We detail the challenges associated with solving the coverage planning problem in an unknown, large ($>\!\!1~km$), and rugged-terrain environment over long-time scales ($>\!\!1~hr$) using a POMDP-RHP formulation. We broadly identify these challenges as computational complexity--in both time and space--and safety-critical plan concatenation.
